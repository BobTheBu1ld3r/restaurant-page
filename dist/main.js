...
function renderHomePage() {
  ...
  menusButtons.forEach(function (button) {
    return button.addEventListener("click", _menus_js__WEBPACK_IMPORTED_MODULE_1__["default"]);
  });
}
...
function renderPrivateDiningPage() {
  ...
  var privateDiningButton = document.querySelector("button.link.private-dining");
...
var render = function render(htmlContent) {
  return document.querySelector("div.content").innerHTML = htmlContent;
};
...
menusButtons.forEach(function (button) {
  return button.addEventListener("click", _menus_js__WEBPACK_IMPORTED_MODULE_5__["default"]);
});
